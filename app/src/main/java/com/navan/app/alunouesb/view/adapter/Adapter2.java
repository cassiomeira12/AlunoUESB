...
public abstract class Adapter2<T> extends RecyclerView.Adapter implements View.OnClickListener, View.OnLongClickListener {
    ...
    public Adapter2(@NonNull List<T> itensList, @NonNull Context context, @NonNull Actions actions) {
